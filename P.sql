...
-- 업무가 JONES와 같거나 월급이 FORD 이상인 사원의 이름,업무,부서번호,급여 추출

-- SCOTT 또는 WARD와 월급이 같은 사원의 이름,업무,급여를 추출

-- SALES에서 근무하는 사원과 같은 업무를 하는 사원의 이름,업무,급여,부서번호 추출

-- 자신의 업무별 평균 월급보다 낮은 사원의 부서번호, 이름, 급여, 자신의 부서 평균급여를 추출

-- 사원번호,사원명,부서명,소속부서 인원수,업무,소속 업무 급여평균,급여를 추출

-- 사원번호,사원명,부서번호,업무,급여, 자신의 소속 업무 평균급여를 추출

-- 최소한 한 명의 부하직원이 있는 관리자의 사원번호,이름,입사일자,급여 추출

-- 부하직원이 없는 사원의 사원번호, 이름, 업무, 부서번호 추출

-- BLAKE의 부하직원의 이름, 업무, 상사번호 추출

-- BLAKE와 같은 상사를 가진 사원의 이름,업무, 상사번호 추출   
